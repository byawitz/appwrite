...
App::delete('/v1/teams/:teamId')
 ...
 ->inject('project')
 ->action(function (string $teamId, Response $response, Database $dbForProject, Database $dbForConsole, Event $queueForEvents, Delete $queueForDeletes, Document $project) {
